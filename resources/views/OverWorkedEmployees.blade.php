         ...
         <a href="#">
          <i class="fa fa-bar-chart"></i><span>Work-Shift Management</span>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="OverWorkedEmp"><i class="fa fa-plus-circle"></i>Over Worked Employees</a></li>
    ...
    <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tbody><tr>
                  ...
                  <th>Services</th>
                  <th>Efficiency</th>
                  <th>Over-worked hours</th>
                  <th>Over-worked percentage</th>
                  <th>reason</th>
                </tr>
                <tr>
                  <td>John Doe</td>
                  <td><span class="badge bg-yellow">cleaning</span></td>
                  <td>
                  ...
                  <td>15</td>
                  <td><span class="label label-danger">80%</span></td>
                  <td>Over time</td>
                </tr>
                <tr>
                  ...
                  <td>10</td>
                  <td><span class="label label-danger">70%</span></td>
                  <td>Over time Assigned due to customer request</td>
                </tr>
                <tr>
                  <td>Bob Doe</td>
                  <td>1<span class="badge bg-red">Valet</span></td>
                  <td>
                  <div class="progress progress-xs">
                      <div class="progress-bar progress-bar-danger" style="width: 55%"></div>
                  </div>
