         ...
         <a href="#">
          <i class="fa fa-money"></i><span>Finance Management</span>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="Income&Expenditure"><i class="fa fa-files-o"></i>Income & Exp. Management</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Income and Expenditure Details</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-success" style="margin-top:50px;">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Monthy Revenues</h3>
            ...
            <div class="box-body">
              <div id="donut-chart" style="height: 300px; padding: 0px; position: relative;"><canvas class="flot-base" width="505" height="300" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 505px; height: 300px;"></canvas><canvas class="flot-overlay" width="505" height="300" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 505px; height: 300px;"></canvas><span class="pieLabel" id="pieLabel0" style="position: absolute; top: 71px; left: 308.5px;"><div style="font-size:13px; text-align:center; padding:2px; color: #fff; font-weight: 600;">Series2<br>30%</div></span><span class="pieLabel" id="pieLabel1" style="position: absolute; top: 211px; left: 286.5px;"><div style="font-size:13px; text-align:center; padding:2px; color: #fff; font-weight: 600;">Series3<br>20%</div></span><span class="pieLabel" id="pieLabel2" style="position: absolute; top: 130px; left: 127.5px;"><div style="font-size:13px; text-align:center; padding:2px; color: #fff; font-weight: 600;">Series4<br>50%</div></span></div>
            </div>
          </div>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Monthy Expenses</h3>
