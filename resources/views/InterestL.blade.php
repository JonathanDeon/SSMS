...
<head>
  ...
  <title>Liability Interest Information</title>
...
<div class="wrapper">
         ...
         <a href="#">
          <i class="fa fa-money"></i><span>Finance Management</span>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="liabilityInterest"><i class="fa fa-object-group"></i>Liability Interest Information</a></li>
  ...
  <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Liability Interest Information</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box" id="content">
            <div class="box-header">
              <h3 class="box-title">Liability Interest Information</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body" action="{{url('search/autocomplete')}}" method="GET" submit="">
              ...
              @include('liabilitiesInterest_search')
                      </div></div></div>
      
                <script>
                        function deleteLiabilityInterest(liabilityID,principal_amount,calculated_interest,total_amount) {
                              swal({
                              ...
                              function(confirm){
                                if(confirm) {
                                  ...
                                  $.ajax({
                                  method:'get',
                                  url:'deleteLiabilityInterest',
                                  data:{liabilityID:liabilityID, principal_amount:principal_amount,calculated_interest:calculated_interest,total_amount:total_amount},
                                  success:function(){
                                    swal({
                                        title: "Deleted!",
