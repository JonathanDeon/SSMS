...
<div class="wrapper">
         ...
         <a href="#">
          <i class="fa fa-bar-chart"></i><span>Work-Shift Management</span>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="EfficiencyAnalysis"><i class="fa fa-plus-circle"></i>Efficiency Analysis</a></li>
            </ul>
       </li>
  ...
  <tbody>
    ...
    <tr>
      <td>Elaquim Mangala</td>
      <td><span class="badge bg-light-blue">Valet</span></td>
      <td>
