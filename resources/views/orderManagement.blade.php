          ...
          <div class="modal fade" id="orderModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              ...
              <label><input type="checkbox" value="" > Floor cleaning</label>
                <div class="radio">
                  <label><input type="radio" name="wood">Hardwood Flooring</label>
                </div>
                ...
                <div style="text-align: left"class="col-md-4 col-sm-4 col-xs-4 col-xxs-12">Total square feet (appr.) :</div>
                <div class="col-md-8">
                <input id="cust" name="custName" type="number" placeholder="" class="form-control input-md">    
                </div>
              </div>
              ...
              <label><input type="checkbox" value="" > Roof cleaning</label>
                <div class="radio">
                  <label><input type="radio" name="asp">Asphalt shingles </label>
                </div>
                <div style="text-align: left"class="col-md-4 col-sm-4 col-xs-4 col-xxs-12">Total square feet (appr.) :</div>
                <div class="col-md-8">
                <input id="cust" name="custName" type="number" placeholder="" class="form-control input-md">    
              ...
              <label><input type="checkbox" value=""> Rooftop cleaning</label>
                <div class="radio">
                  <label><input type="radio" name="ex1">ex</label>
                </div>
              <div style="text-align: left"class="col-md-4 col-sm-4 col-xs-4 col-xxs-12">Total square feet (appr.) :</div>
                <div class="col-md-8">
                <input id="cust" name="custName" type="number" placeholder="" class="form-control input-md">    
              ...
              <label><input type="checkbox" value="" > Pool cleaning</label>
                <div class="radio">
                  <label><input type="radio" name="ex2">ex2</label>
                </div>
              ...
              <label><input type="checkbox" value="" > Bathroom cleaning</label>
                <div class="radio">
                  <label><input type="radio" name="ex3">ex3</label>
                </div>
              ...
              <label><input type="checkbox" value="" > Window cleaning</label>
                <div class="radio">
                  <label><input type="radio" name="ex4">ex4</label>
                </div>
              ...
              <div><div style="text-align: left"class="col-md-4 col-sm-4 col-xs-4 col-xxs-12">Total square feet (appr.) :</div>
                <div class="col-md-8">
                <input id="cust" name="custName" type="number" placeholder="" class="form-control input-md">    
                </div>
              </div>
              ...
              <div class="radio">
                    <label><input type="radio" name="ex">example</label>
