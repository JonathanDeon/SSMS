...
<div class="wrapper">
         ...
         <a href="#">
          <i class="fa fa-money"></i><span>Finance Management</span>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="Liability"><i class="fa fa-plus-circle"></i>Liability Management</a></li>
  ...
  <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Liability Details</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-addLiabilities" style="margin-top:50px;" >
          ...
          <div class="box box-addAsset" style="margin-top:50px;">
            <div class="box-header with-border">
              <h3 class="box-title">Interest Calculation and End of Liability Approximation</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
