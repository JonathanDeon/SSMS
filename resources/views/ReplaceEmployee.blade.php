         ...
         <a href="#">
          <i class="fa fa-bar-chart"></i><span>Work-Shift Management</span>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="ReplaceEmployee"><i class="fa fa-exchange"></i>Replace Employee</a></li>
  ...
  <div>
     ...
     <div class="box box-danger">
            ...
            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              ...
              <div>
              <button type="submit" class="btn btn-primary" style="margin-left:475px; margin-bottom:20px;">OK</button>
              </div>
              </div>
            ...
            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
             ...
             <tbody><tr>
                ...
                <tr>
                  <td>15049128</td>
                  <td>Panchali Nanayakkara</td>
                  <td><span class="badge bg-yellow">Full Interior Grooming</span></td>
                  <td>
                ...
                <tr>
                  <td>1506784</td>
                  <td>Arsene Wenger</td>
                  <td><span class="badge bg-orange">Leather Interior Grooming</span></td>
                  <td>
                     <div class="progress progress-xs">
                ...
                <tr>
                  <td>1504782</td>
                  <td>Karim Benzema</td>
                  <td><span class="badge bg-green">Prestige Valet</span></td>
                  <td>
                     <div class="progress progress-xs">
            ...
            <div>
            <button type="submit" class="btn btn-success" style="margin-left:450px">Replace</button>
            </div>
            </div>
            ...
            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
             ...
             <div>
              <button type="submit" class="btn btn-primary" style="margin-left:460px">Select</button>
              </div>
       ...
       <div class="box box-danger">
            ...
            <div class="box-body no-padding">
              <table class="table table-condensed">
                ...
                <tr>
                  ...
                  <td>
                    <span class="badge bg-orange">Leather Interior Grooming</span>
                  </td>
                  <td>
                    <div class="progress progress-xs">
             ...
             <div class="row">
                <button type="submit" class="btn btn-primary" style="margin-left:175px">Assign</button>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tbody><tr>
                  ...
                  <th style="width:60px;">Services</th>
                  <th style="width:40px;">Efficiency</th>
                  <th style="width:20px; margin-right:0px;">Over-worked percentage</th>
                </tr>
                <tr>
                  <td>183</td>
                  <td>Ichimaru Gin</td>
          ...
          <button type="submit" class="btn btn-primary" style="margin-left:950px">Assign</button>
