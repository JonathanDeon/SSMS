         ...
         <a href="#">
          <i class="fa fa-bar-chart"></i><span>Work-Shift Management</span>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="CreateShifts"><i class="fa fa-plus-circle"></i>Create Shifts</a></li>
          ...
          <div class="box box-primary">
            ...
            <form role="form">
              ...
              <div class="box-footer" style="height:70px">
                <button type="submit" class="btn btn-primary" style="margin-left:400px; margin-top:8px; margin-bottom:8px;" >Submit</button>
              </div>
            </form>
          </div>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body1 no-padding">
              <table class="table table-condensed">
                ...
                <tr>
                  <td>Yusra Frouz</td>
                  <td><span class="badge bg-yellow">Full Interior Grooming</span><span class="badge bg-orange">Leather Interior Grooming</span></td>
                  <td>
                    <div class="progress progress-xs">
                ...
                <tr>
                  <td>Jonathan Deon</td>
                  <td><span class="badge bg-red">Showroom Valet</span></td>
                  <td>
                    <div class="progress progress-xs progress-striped active">
