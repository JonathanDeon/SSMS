        ...
        <li class="treeview">
         ...
         <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ServicePlans"><i class="fa fa-map-o"></i>Service Plans</a></li>
        ...
        <div class="col-xs-12">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td>Quick Wash</td>
                  <td>Body Wash/ Dusting Carpets/ Tyre Dressing</td>
                </tr>
                <tr>
                  <td>219</td>
                  <td>Spick & Span</td>
                  ...
                  <td>Detail Wash</td>
                  <td>Body & Carpet Wash / Interior Vacuum / Glass Cleaning /Tyre & Dash Dressing </td>
                </tr>
                <tr>
                  <td>657</td>
                  <td>Wash & Wax</td>
                  ...
                  <td>Super Wash</td>
                  <td>Detail wash package plus super fast 3m body wax.</td>
                </tr>
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Add/Remove Service Plans</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Service Plan</label>
                ...
                <button type="button" class="btn btn-danger pull-right" onclick="alerts()">Remove</button>
                <button type="button" class="btn btn-primary pull-right" onclick="success()">Add</button>
