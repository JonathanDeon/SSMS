        ...
        <div class="col-xs-6">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <a onclick="window.open('customerReport')" type="button" class="btn btn-block btn-warning btn-lg" style="width: 45%">Generate Customer Report</a>
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <a onclick="window.open('loyaltyReport')" type="button" class="btn btn-block btn-primary btn-lg" style="width: 45%">Generate Loyalty Report</a>
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
                <a onclick="window.open('deficitReport')" type="button" class="btn btn-block btn-success btn-lg" style="width: 45%">Generate Deficit Report</a>
