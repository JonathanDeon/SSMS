        ...
        <a href="#"><div class="col-sm-2 col-md-1">
           <div id="floating" style="width:111px;" >
            <div class="hexagon-md hexagon-danger hexagon-hover">
             ...
             <div style="margin-top:30%;">
                <hexa>Employee Management</hexa>
             </div>
          </div>   
        </div></a>
         
        <a href="Assets"><div class="col-sm-2 col-md-1">
          <div id="floating" style="width:111px;">
            <div class="hexagon-md hexagon-success hexagon-hover">
                  <i class="fa fa-money"></i>
            </div>
             <div style="margin-top:30%;">
                <hexa>Finance Management</hexa>
             </div>
          </div> 
        </div></a>

        <a href="ReservationsService"><div class="col-sm-2 col-md-1">
          <div id="floating" style="width:111px;">
            <div class="hexagon-md hexagon-info hexagon-hover"> 
                  <i class="fa fa-car"></i>
            </div>
             <div style="margin-top:30%;">
                <hexa>Service Management</hexa>
             </div>
          </div>
        </div></a>
        
        <a href="Janitorial"><div class="col-sm-2 col-md-1">
          <div id="floating" style="width:111px;">
            <div class="hexagon-md hexagon-primary hexagon-hover">
                  <i class="fa fa-building"></i>
            </div>
             <div style="margin-top:30%;">
                <hexa>Janitorial Services</hexa>
             </div>
          </div>
        </div></a>

        <a href="AddNewItem"><div class="col-sm-2 col-md-1">
           <div id="floating" style="width:111px;" >
            <div class="hexagon-md hexagon-danger hexagon-hover">
                  <i class="fa fa-cube"></i>
            </div>
             <div style="margin-top:30%;">
                <hexa>Inventory Management</hexa>
             </div>
          </div>   
        </div></a>
          
        <a href="AssignEmployees"><div class="col-sm-2 col-md-1">
          <div id="floating" style="width:111px;">
            <div class="hexagon-md hexagon-success hexagon-hover">
                  <i class="fa fa-briefcase"></i>
            </div>
             <div style="margin-top:30%;">
                <hexa>Work-Shift Management</hexa>
             </div>
          </div> 
        </div></a>
