...
<head>
  ...
  <title>Expenditure Information</title>
...
<li class="treeview">
         ...
         <a href="#">
          <i class="fa fa-money"></i><span>Finance Management</span>
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="expense"><i class="fa fa-credit-card"></i>Expenditure Management</a></li>
            </ul>
       </li>
  ...
  <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Expenditure Information</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <div class="box-body">
              ...
              <form role="form" method="GET" action="{{url('purchases-pdf')}}"> 
            <input name="_token" type="hidden" value="{{ csrf_token() }}"/>                    
                  ...
                  <input type="date" class="form-control" data-inputmask="'alias': 'yyyy/mm/dd'" name="toSalesDate" id="toSalesDate">
                                  ...
                                  <button class="btn btn-primary">Convert to PDF</button>
</form></div><div></div>
...
<div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
              ...
              </table></div></div><div class="row"><div class="col-sm-7"><div class="dataTables_paginate paging_simple_numbers" id="example1_paginate"><ul class="pagination"><li class="paginate_button previous disabled" id="example1_previous"></li><li class="paginate_button active"></li><li class="paginate_button "></li><li class="paginate_button "></li><li class="paginate_button "></li><li class="paginate_button "></li><li class="paginate_button "></li><li class="paginate_button next" id="example1_next"></li></ul></div></div></div></div>
            </div>
            <!-- /.box-body -->
          </div>
</div></div></section>
...
<div class="box">
            ...
            <div class="box-body">
              ...
              <form role="form" method="GET" action="{{url('salaries-pdf')}}"> 
            <input name="_token" type="hidden" value="{{ csrf_token() }}"/>                    
                  ...
                  <input type="date" class="form-control" data-inputmask="'alias': 'yyyy/mm/dd'" name="toSalesDate" id="toSalesDate">
                                  ...
                                  <button class="btn btn-primary">Convert to PDF</button>
</form></div><div></div><div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                <thead>
      ...
      <div class="box">
            ...
            <div class="box-body">
              <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-12"></div><div class="col-sm-6"><div id="example1_filter" class="dataTables_filter">
                ...
                <form role="form" method="GET" action="{{url('purchaseReturns-pdf')}}"> 
            <input name="_token" type="hidden" value="{{ csrf_token() }}"/>                    
                ...
                <tr role="row" class="odd">
                  <td>{{$pReturn->prid}}</td>
                  <td>{{$pReturn->PRdate}}</td>
                  <td>{{$pReturn->PRtotal}}</td>
                </tr>  
                @endforeach  
                </tbody>
                <tfoot>                
